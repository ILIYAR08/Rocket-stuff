...
class H3LIS331DL():
	...
	def select_datarate(self):
		...
		DATARATE_CONFIG = (H3LIS331DL_ACCL_PM_NRMl | H3LIS331DL_ACCL_DR_400 | H3LIS331DL_ACCL_XAXIS | H3LIS331DL_ACCL_YAXIS | H3LIS331DL_ACCL_ZAXIS)
	...
	def select_data_config(self):
		...
		DATA_CONFIG = (H3LIS331DL_ACCL_RANGE_200G | H3LIS331DL_ACCL_BDU_CONT)
...
while time.time() < stop_time:
	...
	t0=time.time()
	datafile.write(str(t0-t1)+str('|')+str(accl['x'])+'|'+str(accl['y'])+'|'+str(accl['z'])+'\n')
	t1=t0
